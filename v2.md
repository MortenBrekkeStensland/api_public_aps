...
## APS API v2 (APS v.4.0 and above) 
...
- `computer_tag`: The user-defined computer tag shown in the online dashboard for the current license. In APS for Windows, this maps to the `PC Tag` setting.
